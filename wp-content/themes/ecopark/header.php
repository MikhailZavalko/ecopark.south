...
<head>
	...
	<link rel="stylesheet" id="main" href="<?php echo $template_url; ?>/css/main.min.css?v=1.17" type="text/css" media="all">
			...
			<div class="main-head">
				...
				<ul class="menu">
					...
					<li>
						...
						<ul class="submenu">
							<li><a href="https://xn--80aeibvb0aikeh1l.xn--p1ai/" target="_blank" rel="nofollow">Экопарк Северный</a></li>
				...
				<a href="tel:+7(4212) 60-29-73" class="header-phone">
					<div class="circle-phone">
					...
					<p><span>+7 (4212) 60-29-73</span><br>г. Хабаровск</p>
				</a>
